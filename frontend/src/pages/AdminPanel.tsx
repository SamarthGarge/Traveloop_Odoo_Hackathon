            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={label} className="card p-5">
                    ...
                    <p className="text-2xl font-bold text-[#0b1c30]">{value?.toLocaleString() ?? '—'}</p>
              ...
              <div className="card p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => setActiveTab('users')} className="text-sm text-[#E8604C] hover:text-[#ae311e]">View All →</button>
                </div>
              ...
              <div className="card p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button onClick={() => setActiveTab('trips')} className="text-sm text-[#E8604C] hover:text-[#ae311e]">View All →</button>
                </div>
                <div className="space-y-2">
                    ...
                    <div key={t.id} className="flex items-center gap-3 p-2.5 rounded-xl hover:bg-[#f8fafc] transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-[#94a3b8]">
                          {t.user?.first_name} {t.user?.last_name} • {new Date(t.start_date).toLocaleDateString()}
                        </p>
                      </div>
                      {t.is_public && (
