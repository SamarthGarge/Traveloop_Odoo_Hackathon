...
// ΓöÇΓöÇ sub-tab components ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function ItineraryView() {
  ...
  // Fetch budget separately (non-critical ΓÇö won't crash page if it fails)
  useEffect(() => {
    if (!id) return;
    apiGetBudget(id)
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[#94a3b8] text-xs mt-0.5">
            {new Date(trip.start_date).toLocaleDateString()} ΓåÆ {new Date(trip.end_date).toLocaleDateString()} ┬╖ {getTripDuration()} days
          </p>
        </div>
        <button
...
// ΓöÇΓöÇ Itinerary Tab ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        {budget && (
          <div className="card p-5">
            ...
            <div className="space-y-2 text-sm">
              ...
              {budget.over_budget && (
                <p className="text-xs text-[#dc2626] bg-[#fef2f2] rounded-lg px-2 py-1.5">ΓÜá Over budget</p>
              )}
            </div>
          </div>
        )}
