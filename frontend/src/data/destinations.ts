...
export const destinations: Destination[] = [
  ...
  { id: 'd15', name: 'London', country: 'UK', image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&q=80&w=800', description: 'Historic landmarks and modern culture', costIndex: 'High', popularity: 94, activities: ['Sightseeing', 'Culture'] },
  { id: 'd17', name: 'Barcelona', country: 'Spain', image: 'https://images.unsplash.com/photo-1583422409516-2895a77efded?auto=format&fit=crop&q=80&w=800', description: 'Art, architecture, and Mediterranean vibes', costIndex: 'Medium', popularity: 91, activities: ['Culture', 'Outdoors'] },
  { id: 'd19', name: 'Singapore', country: 'Singapore', image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&q=80&w=800', description: 'Futuristic city-state with lush greenery', costIndex: 'Very High', popularity: 88, activities: ['Food', 'Culture'] },
  { id: 'd20', name: 'Amsterdam', country: 'Netherlands', image: 'https://images.unsplash.com/photo-1517736996303-4eec4a66bb17?auto=format&fit=crop&q=80&w=800', description: 'Picturesque canals and rich history', costIndex: 'High', popularity: 89, activities: ['Culture', 'Outdoors'] },
  { id: 'd21', name: 'Seoul', country: 'South Korea', image: 'https://images.unsplash.com/photo-1517154421773-0529f29ea451?auto=format&fit=crop&q=80&w=800', description: 'Dynamic metropolis of K-pop and palaces', costIndex: 'Medium', popularity: 87, activities: ['Culture', 'Nightlife'] },
  { id: 'd22', name: 'Rio de Janeiro', country: 'Brazil', image: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?auto=format&fit=crop&q=80&w=800', description: 'Iconic beaches and carnival spirit', costIndex: 'Medium', popularity: 84, activities: ['Outdoors', 'Nightlife'] },
  { id: 'd23', name: 'Vancouver', country: 'Canada', image: 'https://images.unsplash.com/photo-1559511260-66a654ae982a?auto=format&fit=crop&q=80&w=800', description: 'Mountains meet the ocean', costIndex: 'High', popularity: 85, activities: ['Outdoors', 'Food'] },
  { id: 'd24', name: 'Prague', country: 'Czech Republic', image: 'https://images.unsplash.com/photo-1519677100203-a0e668c92439?auto=format&fit=crop&q=80&w=800', description: 'The City of a Hundred Spires', costIndex: 'Low', popularity: 88, activities: ['Culture', 'Nightlife'] },
  { id: 'd25', name: 'Vienna', country: 'Austria', image: 'https://images.unsplash.com/photo-1516550893923-42d28e5677af?auto=format&fit=crop&q=80&w=800', description: 'Imperial history and classical music', costIndex: 'High', popularity: 86, activities: ['Culture', 'Food'] },
  { id: 'd26', name: 'Kyoto', country: 'Japan', image: '/images/image.png', description: 'Historic temples, traditional gardens, and geisha districts', costIndex: 'High', popularity: 90, activities: ['Culture', 'Outdoors'] },
  { id: 'd27', name: 'Buenos Aires', country: 'Argentina', image: 'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?auto=format&fit=crop&q=80&w=800', description: 'Tango, steak, and European architecture', costIndex: 'Medium', popularity: 82, activities: ['Food', 'Nightlife'] },
  { id: 'd28', name: 'Munich', country: 'Germany', image: 'https://images.unsplash.com/photo-1595867451639-65d1d6a66a1a?auto=format&fit=crop&q=80&w=800', description: 'Bavarian culture and Oktoberfest', costIndex: 'High', popularity: 83, activities: ['Culture', 'Food'] },
  { id: 'd29', name: 'Lisbon', country: 'Portugal', image: 'https://images.unsplash.com/photo-1509824227185-9c5a01ceba0d?auto=format&fit=crop&q=80&w=800', description: 'Sun-kissed hills and historic trams', costIndex: 'Low', popularity: 87, activities: ['Culture', 'Food'] },
];
